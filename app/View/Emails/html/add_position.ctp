    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<h1 style="font:bold 15px Arial, Helvetica, sans-serif; color:#212428; margin:0 0 10px 0;">Dear <?php echo $to_name?>,</h1>
          <p style="font:13px Arial, Helvetica, sans-serif; color:#212428; margin:0;">The following position is created by <?php echo $from_name;?>. Please login to manage hiring and approve the requirement quickly. After your approval only recruiters can create resumes for this requirement.</p><br />
          ...
          <table width="100%" border="0" cellspacing="2" cellpadding="10" style="border:1px solid #ededed; font:bold 13px Arial, Helvetica, sans-serif; color:#212428; margin:10px 0 20px 0;">
			...
			<tr style="background:#f5f4f4;">
			  ...
			  <tr style="background:#f5f4f4;">
			   <td>Job Title</td>
              <td   style="color:#2a2a2a;"><?php echo $position; ?></td>
			  
			   <td>Job Location</td>
              <td  style="color:#2a2a2a;"><?php echo $location; ?></td>
