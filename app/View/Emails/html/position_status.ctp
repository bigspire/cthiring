    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<h1 style="font:bold 15px Arial, Helvetica, sans-serif; color:#676767; margin:0 0 10px 0;">Dear <?php echo $to_name?>,</h1>
          <p style="font:13px Arial, Helvetica, sans-serif; color:#676767; margin:0;">The following position status is changed to not billable by <?php echo $from_name;?></p><br />
