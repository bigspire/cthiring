<div id="container">
		...
		<button type="button" class="close" data-dismiss="alert-success">×</button>CV Rejected Successfully</div>
		Redirecting now...
		<?php endif; ?>	
...
<input type="hidden" id="success_page" value="<?php echo $this->webroot;?>position/view/<?php echo $this->request->params['pass'][1]?>/?tab=upload_status"/>
