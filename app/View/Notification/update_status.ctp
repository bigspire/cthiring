	...
	<div class="row-fluid">
		<div class="span6">
			<table class="table table-bordered dataTable" align="centre">
				...
				<tr class="tbl_row" >
					<td width="120" class="tbl_column">Job Title
					</td>
						<td>
						<?php echo $this->Form->input('job_title', array('div'=> false,'type' => 'text', 'label' => false, 
						'class' => 'span8', 'readonly' => 'readonly', 'value' => $this->request->query['title'], 
		...
		'style' => "clear:left", 'options' => $rejectList, 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
				...
				<tr class="tbl_row" >
					<td width="120" class="tbl_column">Remarks 					<span class="f_req">*</span>
