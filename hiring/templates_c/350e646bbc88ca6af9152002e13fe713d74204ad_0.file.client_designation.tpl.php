...
home"><i class="icon-home"></i></a>
						...
						<div class="srch_buttons">
							...
							<?php if (!$_smarty_tpl->tpl_vars['ALERT_MSG']->value) {?>
								<a href="client_designation.php?action=export&keyword=<?php echo $_POST['keyword'];?>

								&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
" class="jsRedirect">
								<button type="button" val="client_designation.php?action=export&keyword=<?php echo $_POST['keyword'];?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
...
" class="input-large" aria-controls="dt_gal"></label>
						...
						<input type="hidden" value="#" id="webroot">
							...
							<table class="table table-striped table-bordered dataTable stickyTable">
								<thead>
									<tr>
										<th width="180"><a href="client_designation.php?field=designation&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
...
">Designation</a></th>
										...
										<th width="80"><a href="client_designation.php?field=created_date&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
" class="<?php echo $_smarty_tpl->tpl_vars['sort_field_created_date']->value;?>
">Created Date</a></th>
										<th width="80"><a href="client_designation.php?field=modified_date&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
...
'><?php echo $_smarty_tpl->tpl_vars['item']->value['status'];?>
										...
										<a href="edit_client_designation.php?id=<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
...
&type=CL" href="javascript:void(0)" rel="tooltip" class="btn Confirm btn-mini" value="#"  title="Delete"><i class="icon-trash"></i></a>
										</td>  
									</tr>		
