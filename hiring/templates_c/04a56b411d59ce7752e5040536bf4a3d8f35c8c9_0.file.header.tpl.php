<?php
/* Smarty version 3.1.29, created on 2017-01-31 16:56:35
  from "/var/www/html/cthiring/templates/include/header.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5890746bc2b242_76699918',
  'file_dependency' => 
  array (
    '04a56b411d59ce7752e5040536bf4a3d8f35c8c9' => 
    array (
      0 => '/var/www/html/cthiring/templates/include/header.tpl',
      1 => 1485861984,
      2 => 'file',
    ),
  ),
...
function content_5890746bc2b242_76699918 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
                                ...
                                <div class="nav-collapse">
                                    <ul class="nav">
                                       <li class="<?php echo '<?php ';?>echo $fun->set_menu_active(array('recruiter_dashboard'));<?php echo '?>';?> dropdown">
                                        ...
                                        <li class="dropdown <?php echo '<?php ';?>echo $fun->set_menu_active(array('resume','view_resume','add_resume','edit_resume','req_resume','add_formatted_resume','edit_formatted_resume'));<?php echo '?>';?>">
                                         ...
                                         <li class="dropdown <?php echo '<?php ';?>echo $fun->set_menu_active(array('interview','view_interview'));<?php echo '?>';?>">
 ...
 dropdown">
										 ...
										 <li class="dropdown">
                                          ...
                                          <ul class="dropdown-menu">
                                           ...
                                           <li class="dropdown <?php echo '<?php ';?>echo $fun->set_menu_active(array('mailbox'));<?php echo '?>';?>">
