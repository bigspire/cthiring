<?php
/* Smarty version 3.1.29, created on 2017-11-06 16:02:16
  from "C:\xampp\htdocs\2017\ctsvn\cthiring\hiring\templates\functional_area.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a003a30828916_14348343',
  'file_dependency' => 
  array (
    'ce097c58cdf1b7b8557315e7ab78ef6bdd7d9d41' => 
    array (
      0 => 'C:\\xampp\\htdocs\\2017\\ctsvn\\cthiring\\hiring\\templates\\functional_area.tpl',
      1 => 1509964328,
      2 => 'file',
    ),
  ),
...
function content_5a003a30828916_14348343 ($_smarty_tpl) {
...
home"><i class="icon-home"></i></a>
						...
						<div class="srch_buttons">
							...
							<?php if (!$_smarty_tpl->tpl_vars['ALERT_MSG']->value) {?>
								<a href="functional_area.php?action=export&keyword=<?php echo $_POST['keyword'];?>

								&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
" class="jsRedirect">
								<button type="button" val="functional_area.php?action=export&keyword=<?php echo $_POST['keyword'];?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
" name="export" class="btn btn-warning" >Export Excel</button></a>
							<?php }?>
							<a class="jsRedirect" data-notify-time = '3000'   href="add_functional_area.php">
							<input type="button" value="Create Functional Area" class="btn btn-info"/></a>	
						</div>
...
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'hide', 0);?>
 ...
 dataTables_filter srchBox" style="float:left;" id="dt_gal_filter">
								...
								<label style="margin-left:0;">Keyword: <input type="text" placeholder="Functional Area Name" name="keyword" id="keyword" value="<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
" class="input-large" aria-controls="dt_gal"></label>
							...
							<label style="margin-top:18px;"><a href="functional_area.php" class="jsRedirect"><input value="Reset" type="button" class="btn"/></a></label>
						...
						<input type="hidden" value="#" id="webroot">
							...
							<table class="table table-striped table-bordered dataTable stickyTable">
								<thead>
									<tr>
										<th width="180"><a href="functional_area.php?field=function&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&f_date=<?php echo $_smarty_tpl->tpl_vars['f_date']->value;?>
&t_date=<?php echo $_smarty_tpl->tpl_vars['t_date']->value;?>
" class="<?php echo $_smarty_tpl->tpl_vars['sort_field_function']->value;?>
">Functional Area</a></th>
										<th width="80">Status</a></th>
										<th width="80"><a href="functional_area.php?field=created_date&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
" class="<?php echo $_smarty_tpl->tpl_vars['sort_field_created_date']->value;?>
">Created Date</a></th>
										<th width="80"><a href="functional_area.php?field=modified_date&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
...
?>	
									<tr>
										<td><?php echo $_smarty_tpl->tpl_vars['item']->value['function'];?>
</td>
...
'><?php echo $_smarty_tpl->tpl_vars['item']->value['status'];?>
										...
										<a href="edit_functional_area.php?id=<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
...
<input type="hidden" id="page" value="list_functional_area">
<input type="hidden" id="web_root" value="delete_functional_area.php">	
              </div>
            </div>
     </div>
		</div>
