                ...
                <div class="main_content">
					...
					<div class="row-fluid">
						...
						{/if}
							...
							<label>Billing From: 
							<input type="text" class="input-small datepick" name="f_date" placeholder="dd/mm/yyyy" value="{$f_date}" aria-controls="dt_gal"></label>
							<label>Billing Till:
							<input type="text" name="t_date" value="{$t_date}" placeholder="dd/mm/yyyy" class="input-small datepick" aria-controls="dt_gal"></label>
							</span></span>
							...
							<table class="table table-striped table-bordered dataTable stickyTable">
								<thead>
									<tr>
										...
										<th width="80"><a href="billing.php?field=account_holder&order={$order}&page={$smarty.get.page}&keyword={$keyword}&f_date={$f_date}&t_date={$t_date}" rel="tooltip" data-original-title="Sort by Ascending or Descending" class="{$sort_field_billing_date}">Account Holder</a></th>
