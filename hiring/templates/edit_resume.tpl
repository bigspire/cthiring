...
<textarea placeholder="" name="consultant" tabindex="1" id="consultant" cols="10" rows="3" class="span10 wysiwyg1">{if $consultant}{$consultant}{else}{$smarty.post.consultant}{/if}</textarea>
									...
									<tr class="">
										...
										<td>
<textarea placeholder="" name="other_input" tabindex="1" id="other_input" cols="10" rows="3" class="span10 wysiwyg1">{if $other_input}{$other_input}{else}{$smarty.post.other_input}{/if}</textarea>
										</td>	
									</tr>													
								</tbody>
							</table>
