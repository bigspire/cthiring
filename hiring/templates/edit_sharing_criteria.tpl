			...
			<table class="table table-bordered dataTable" style="margin-bottom:0;">
				<tbody>
						<tr class="tbl_row">
							...
							<td>										
								...
								<option value="">Select</option>	
									{html_options options=$type_name selected=$inc_sharing_id}								
								</select>
						...
						<tr>
							...
							<td>										
								<input type="text" tabindex="3" name="percent" value="{$percent}" class="span8">
					...
					<tr class="tbl_row"> 
						...
						<td>	
							<select name="status" class="span8"  tabindex="2" id="PositionEmpId">
								{html_options  id="grade_status" options=$grade_status selected=$status}	
							</select> 
