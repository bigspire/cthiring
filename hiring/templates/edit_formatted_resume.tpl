						...
						<tbody>
								...
								<label for="reg_city" generated="true" class="error">Please enter the candidate name  </label>
									...
									<tr>
										...
										<td>	
										<input type="text" tabindex="7" id="email" name="email" value="pratik@bigspire.com" class="span8">
										<!--label for="reg_city" generated="true" class="error">Please enter the email </label-->																						
										</td>	
									</tr>	
                          ...
                          <tr class="tbl_row">
										...
										<td>
										<input type="text" tabindex="7" name="job_title" id="keyword" value="9822149357" class="span8 ui-autocomplete-input" autocomplete="off">							
									<!--	<label for="reg_city" generated="true" class="error">Please enter the mobile </label>	-->								
										</td>		
									</tr>	
									...
									<tr>
										...
										<td>
										<input type="text" tabindex="7" name="candidate_name" value="" class="span8">
									<!--	<label for="reg_city" generated="true" class="error">Please enter the telephone </label> -->
										</td>	
									</tr>								
									<tr class="tbl_row">
										<td width="120" class="tbl_column">DOB <span class="f_req">*</span></td>
										<td> 
										<input name="dob" tabindex="4" value="30/07/1992"  class="datepick span8" placeholder="" type="text" id="HrEmployeeDob">										
										<!--label for="reg_city" generated="true" class="error">Please enter the dob  </label-->																					
										</td>
									</tr>	
									...
									<tr>
										...
										<td> 
										<input type="text" tabindex="7" name="billing_amount" id="keyword" value="" class="span8 ui-autocomplete-input" autocomplete="off">
										<!--label for="reg_city" generated="true" class="error">Please enter the billing date  </label-->																					
										</td>
									</tr>
									...
									<tr>
										...
										<td><select name="year_of_exp" tabindex="18" class="span4">
...
<option value="50">50 Years</option>
										...
										<select name="month_of_exp" tabindex="19" class="inline_text span4">
...
<option value="11">12 Months</option>
									...
									<tr class="tbl_row">
										...
										<td>
								        <input type="text" tabindex="7" name="present_location" placeholder="" value="Bangalore" class="span8">								
										<!--<label for="reg_city" generated="true" class="error">Please enter the candidate name  </label>-->
										</td>	
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
										<input type="text" tabindex="7" name="job_title" id="keyword" value="" class="span8 ui-autocomplete-input" autocomplete="off">							
									<!--	<label for="reg_city" generated="true" class="error">Please enter the nationality   </label>		-->								
										</td>		
									</tr>
									...
									<!--	<label for="reg_city" generated="true" class="error">Please select the languages    </label>		-->								
										</td>		
									</tr>					
								</tbody>
							</table>
						...
						<div class="span6">		
							<table class="table table-bordered dataTable" style="margin-bottom:0;">
								...
								<tr class="tbl_row">
										...
										<input type="text" value="5.6"  name="ctc1_#index#"  id="ctc1#index#" placeholder="Present"  class="span2"/>										
										...
										<input type="text" name="ctc2_#index#"  id="ctc2#index#" placeholder="Expected" value="8.6" class="span2"/>	
...
<select name="" class="span8"  id="PositionEmpId">	
									...
									<tr class="tbl_row">
									 ...
									 <tr>
										...
										<td>
										<input type="radio" name="single" value="single" checked> Unmarried
                              <input type="radio" name="single" value="" > Married
									...
									<tr>
										...
										<td>
										<textarea name="skills" id="skills" cols="10" rows="3" class="span8"> </textarea>									
										<!-- <label for="reg_city" generated="true" class="error">Please enter the computer skills </label> -->
										</td>	
									</tr>									
									...
									<tr class="tbl_row">
										...
										<td>
										 <textarea name="skills" id="skills" cols="10" rows="3" class="span8"> </textarea>									
										<label for="reg_city" generated="true" class="error">Please enter the address  </label>
										</td>	
									</tr>
									...
									<tr>
										...
										<td>
										<textarea name="skills" id="skills" cols="10" rows="3" class="span8"> </textarea>									
									<!--	<label for="reg_city" generated="true" class="error">Please enter the hobbies </label> -->
										</td>	
									</tr>	
								</tbody>
							</table>
  ...
  <div id="sheepItForm_template" class="" style="clear:left;">
			...
			<table class="table table-bordered dataTable" style="margin-bottom:0;">
						<tbody>
									...
									<!--	<label for="reg_city" generated="true" class="error">Please select the specialization </label>	-->									
										</td>		
									</tr>
						         <tr class="tbl_row">
									...
									<!--	<label for="reg_city" generated="true" class="error">Please enter the university </label> -->
										</td>	
									</tr>
							<!--<tr>
										<td width="120" class="tbl_column"> Course Type </td>
										<td>
									<select name="coursetype_#index#" class="span8"  id="coursetype#index#">	
										<option >Select</option>									
									  ...
									  <option value="3">Correspondence</option>																			
										...
										<label for="reg_city" generated="true" class="error">Please select the course type </label>									
										</td>	
										</tr> -->	
										<tr>
			...
			<table class="table table-bordered dataTable" style="margin-bottom:0;">
						<tbody>
									...
									<!--	<label for="reg_city" generated="true" class="error">Please select the degree </label> -->
										</td>	
									</tr>
									...
									<tr class="tbl_row">
										...
										<td>
										<input type="text" tabindex="7" name="per_ofmarks_#index#" id="per_ofmarks#index#" value="80" class="span4 ui-autocomplete-input" autocomplete="off">			
								     <!--<label for="reg_city" generated="true" class="error">Please enter the % of marks  </label>	-->	
