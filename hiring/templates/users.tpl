                ...
                <div class="main_content">              				
					...
					<div class="row-fluid">
                        ...
                        <div id="jCrumbs" class="breadCrumb module">
							...
							{if !$ALERT_MSG}
								<a href="users.php?action=export&keyword={$keyword}&status={$status}">
								<button type="button" val="users.php?action=export&keyword={$keyword}&status={$status}" name="export" class="jsRedirect btn btn-warning" >Export Excel</button></a>
							{/if}
